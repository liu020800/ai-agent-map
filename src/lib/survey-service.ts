...
export const SURVEY_TOOLS: { id: string; name: string; category: "agent" | "app" | "automation" | "local"; desc: string; tone: string }[] = [
  ...
  { id: "openclaw", name: "OpenClaw", category: "agent", desc: "开源 Agent 编程与任务执行", tone: "#38bdf8" },
  { id: "hermes", name: "Hermes", category: "agent", desc: "多 Agent 自动化协作系统", tone: "#c084fc" },
  { id: "cursor", name: "Cursor", category: "agent", desc: "AI-first 编辑器", tone: "#8b5cf6" },
  { id: "windsurf", name: "Windsurf", category: "agent", desc: "面向开发者的 Agent IDE", tone: "#14b8a6" },
  { id: "trae", name: "Trae", category: "agent", desc: "AI 原生代码编辑器", tone: "#60a5fa" },
  { id: "codebuddy", name: "CodeBuddy", category: "agent", desc: "腾讯云 AI 编码助手", tone: "#818cf8" },
  { id: "github-copilot", name: "GitHub Copilot", category: "agent", desc: "经典 AI 编程助手", tone: "#22c55e" },
  { id: "replit-agent", name: "Replit Agent", category: "agent", desc: "在线应用构建 Agent", tone: "#f97316" },
  { id: "v0", name: "v0", category: "agent", desc: "Vercel AI 前端生成工具", tone: "#f8fafc" },
  { id: "bolt-new", name: "Bolt.new", category: "agent", desc: "浏览器内 AI 全栈开发", tone: "#fde047" },
  { id: "lovable", name: "Lovable", category: "agent", desc: "用自然语言生成 Web App", tone: "#fb7185" },
  { id: "chatgpt", name: "ChatGPT", category: "app", desc: "OpenAI 通用 AI 助手", tone: "#10a37f" },
  { id: "claude", name: "Claude", category: "app", desc: "长文写作与推理助手", tone: "#d97706" },
  { id: "gemini", name: "Gemini", category: "app", desc: "Google 多模态 AI 助手", tone: "#4285f4" },
  ...
  { id: "yuanbao", name: "腾讯元宝", category: "app", desc: "腾讯系通用 AI 助手", tone: "#06b6d4" },
  { id: "ernie", name: "文心一言", category: "app", desc: "百度智能创作与问答", tone: "#2563eb" },
  { id: "perplexity", name: "Perplexity", category: "app", desc: "AI 搜索与研究助手", tone: "#20c7b5" },
  { id: "grok", name: "Grok", category: "app", desc: "实时信息与对话助手", tone: "#94a3b8" },
  { id: "poe", name: "Poe", category: "app", desc: "多模型聊天聚合平台", tone: "#f43f5e" },
  { id: "manus", name: "Manus", category: "agent", desc: "通用任务执行 Agent", tone: "#e879f9" },
  { id: "genspark", name: "Genspark", category: "app", desc: "AI 搜索与内容生成", tone: "#a3e635" },
  { id: "notebooklm", name: "NotebookLM", category: "app", desc: "资料阅读与笔记问答", tone: "#facc15" },
  { id: "gamma", name: "Gamma", category: "app", desc: "AI 演示文稿生成", tone: "#a78bfa" },
  { id: "napkin", name: "Napkin AI", category: "app", desc: "AI 图解与视觉表达", tone: "#f472b6" },
  { id: "monica", name: "Monica", category: "app", desc: "浏览器侧边栏 AI 助手", tone: "#22d3ee" },
  ...
  { id: "coze", name: "扣子 / Coze", category: "automation", desc: "Bot 与工作流搭建平台", tone: "#7c3aed" },
  { id: "langchain", name: "LangChain", category: "automation", desc: "LLM 应用开发框架", tone: "#16a34a" },
  { id: "llamaindex", name: "LlamaIndex", category: "automation", desc: "RAG 数据连接框架", tone: "#0ea5e9" },
  { id: "flowise", name: "Flowise", category: "automation", desc: "可视化 LLM 工作流", tone: "#34d399" },
  { id: "n8n", name: "n8n", category: "automation", desc: "可编程的自动化工作流", tone: "#ec4899" },
  { id: "make", name: "Make", category: "automation", desc: "跨平台自动化编排", tone: "#a855f7" },
  { id: "zapier", name: "Zapier", category: "automation", desc: "无代码自动化连接器", tone: "#ff4f00" },
  { id: "ollama", name: "Ollama", category: "local", desc: "本地大模型推理引擎", tone: "#84cc16" },
  { id: "lm-studio", name: "LM Studio", category: "local", desc: "本地模型桌面运行环境", tone: "#64748b" },
  { id: "jan", name: "Jan", category: "local", desc: "开源本地 AI 助手", tone: "#14b8a6" },
  { id: "open-webui", name: "Open WebUI", category: "local", desc: "自托管模型聊天界面", tone: "#38bdf8" },
  { id: "anythingllm", name: "AnythingLLM", category: "local", desc: "本地知识库与 RAG", tone: "#f59e0b" },
  { id: "comfyui", name: "ComfyUI", category: "local", desc: "节点式 AI 图像工作流", tone: "#ec4899" },
  { id: "stable-diffusion", name: "Stable Diffusion", category: "local", desc: "本地开源图像生成", tone: "#8b5cf6" },
  { id: "midjourney", name: "Midjourney", category: "app", desc: "高质量 AI 图像生成", tone: "#f97316" },
  { id: "jimeng", name: "即梦 AI", category: "app", desc: "图像与视频创作工具", tone: "#f472b6" },
  { id: "kling", name: "可灵 AI", category: "app", desc: "AI 视频生成工具", tone: "#06b6d4" },
  { id: "runway", name: "Runway", category: "app", desc: "视频生成与创意编辑", tone: "#a3e635" },
];
